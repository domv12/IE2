...
<html>
 ...
 <script  type ="text/javascript">
   ...
   function list()
    ...
    <input name="item_code" type="hidden" value="${item.userId}">
        <div align="center">
            <h1>Item Detail</h1>
            <table border="1">
 
                <tr>
                       <th>Item Name</th>   <td> <input name="item_name" value="${item.firstName}"></td>
 
                </tr>
             <tr>
                       <th>Price</th>   <td> <input name="price" value="${item.lastName}"></td>
 
                </tr>
             <tr>
                       <th>Quantity</th>   <td> <input name="qty" value="${item.email}"></td>
